...
{ 
    ...
    { 
     ...
     ReadConsoleInput(hin, &InputRecord, 5, Events); 
     ...
     switch (InputRecord.EventType){ 
       ...
       case MOUSE_EVENT: // mouse input 
        ...
        { 
         ...
         setcolor(3);
         //std::cout << "#";
         drawcircle(InputRecord.Event.MouseEvent.dwMousePosition.X, InputRecord.Event.MouseEvent.dwMousePosition.Y, 10, 10, 4);
...
void clearscreen(){ 
    ...
    FillConsoleOutputCharacter(hConsole, TEXT(' '), dwConSize, {0,0}, &cCharsWritten); 
    GetConsoleScreenBufferInfo(hConsole, &csbi); 
...
//Keyboard(key, type, state)
//SpecialKey(keySpecial, type, state)
//GetAsyncKeyState GetKeyState
// Teno para detectar mouse y teclado genial*/